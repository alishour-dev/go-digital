...
const ProjCarousel5 = ( { alt, carouselClass, fadeSlide, controls, touch, indicators, interval, variant } ) => {

    const data = useStaticQuery(graphql`
        query {
            gallery: allFile(
            filter: {relativeDirectory: {eq: "proj-5"}}
